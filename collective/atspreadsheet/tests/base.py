...
def setup_product():
    ...
    import collective.atspreadsheet
    zcml.load_config('configure.zcml', collective.atspreadsheet)
    ...
    ztc.installPackage('collective.atspreadsheet')
...
setup_product()
ptc.setupPloneSite(products=['collective.atspreadsheet'])
